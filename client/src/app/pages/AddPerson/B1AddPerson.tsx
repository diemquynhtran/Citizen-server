				...
				<Grid container xs={12}>
					...
					<Grid item xs={2}>
						<Box p={2}>
							...
							<Dialog
							open={alertOpen}>
								<DialogTitle>Khai báo Hoàn thành?</DialogTitle>
								<DialogContent>
									<DialogContentText id="alert-dialog-description">
										Bạn có muốn xác nhận là đã điều tra hết khu vực của bạn?
									</DialogContentText>
									...
									<DialogActions>
										...
										<Button onClick={handleConfirmCompletion} color="primary" autoFocus>
											Có
										</Button>
									</DialogActions>
								</DialogContent>
